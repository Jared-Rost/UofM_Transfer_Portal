...
const getQuotes = async () => {
  ...
  // create a new table with all the information 

  // then export it to a CSV


  // console.log(instituitionsDescriptions[0] + "\n");
  // console.log(instituitionsDescriptions[1] + "\n");
  // console.log(instituitionsDescriptions[2] + "\n");

  // console.log(allCourses[0] + "\n");
  // console.log(allCourses[1] + "\n");

  /* console.log(allCourses[0][0] + "\n");
  console.log(allCourses[0][1] + "\n");
  console.log(allCourses[0][2] + "\n");
  console.log(allCourses[0][3] + "\n");
  console.log(allCourses[1][0] + "\n");
  console.log(allCourses[1][1] + "\n");
  console.log(allCourses[1][2] + "\n");
  console.log(allCourses[1][3] + "\n");
  console.log(allCourses[2][0] + "\n");
  console.log(allCourses[2][1] + "\n");
  console.log(allCourses[2][2] + "\n");
  console.log(allCourses[2][3] + "\n"); */

  //console.log(allCourses[0].length + "\n");
  //console.log(allCourses[0] + "\n");

  /* console.log(allCourses[0].length + "\n");
  console.log(allCourses[1].length + "\n");
  console.log(allCourses[2].length + "\n"); */
